...
<!-- header -->
	...
	<h2></h2>
				 ...
				 <div class="col-md-6  register-top-grid">
					    <h3>View Engagegement Details</h3>
...
<center>
    <table >
  <tr>
      <th scope="row">Member ID</th> <th scope="row">Engagement Date</th><th scope="row">Engagement Place</th> <th scope="row">Spouse Name</th><th scope="row">Status</th><th scope="row" colspan="2">Remarks</th>
  </tr>
  
  <?php
  include 'connection.php';
  $s="select * from engagement";
  $s1=  mysqli_query($con, $s);
  while ($s2=  mysqli_fetch_assoc($s1))
  {
      $marriagedate=$s2['engagementdate'];
      $marriageplace=$s2['engagementplace'];
      $sname=$s2['spousename'];
     $id=$s2['memberid'];
      $status=$s2['status'];
 ...
 <td><a href="enapprove.php?id=<?php echo $id;?>">APPROVE</a></td><td><a href="endelete.php?id=<?php echo $id;?>">DELETE</a></td></tr>
