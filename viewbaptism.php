...
<!-- header -->
	...
	<h2></h2>
				 ...
				 <div class="col-md-6  register-top-grid">
					    <h3>View Baptism Details</h3>
        
        
        
        
        <form name="frmm" method="post" action="viewbaptismaction.php">
<center>
    <table >
  <tr>
      <th scope="row">Member ID</th> <th scope="row">Baptismal Name</th><th scope="row">Baptismal Date</th> <th scope="row">Baptismal Place</th><th scope="row">Godfather's Name</th>  <th scope="row">Godfather's Parish</th>  <th scope="row">Godfather's Housename</th><th scope="row">Status</th><th scope="row" colspan="2">Remarks</th>
  </tr>
  
  <?php
  include 'connection.php';
  $s="select * from baptism";
  $s1=  mysqli_query($con, $s);
  while ($s2=  mysqli_fetch_assoc($s1))
  {
    $baptismalname = $s2['baptismalname'];
    $baptismaldate = $s2['baptismaldate'];
    $baptismalplace = $s2['baptismalplace'];
    $godfathersname = $s2['godfathersname'];
    $godfathersparish = $s2['godfathersparish'];
    $godfathershousename = $s2['godfathershousename'];
      $id=$s2['memberid'];
     $status=$s2['status'];
  ...
  ?>
    <tr><td><?php echo $id; ?></td><td><?php echo $baptismalname; ?></td>
 <td><?php echo $baptismaldate; ?></td><td><?php echo $baptismalplace; ?></td>
 <td><?php echo $godfathersname; ?></td><td><?php echo $godfathersparish; ?></td>
 <td><?php echo $godfathershousename; ?></td><td><?php echo $status; ?></td>

 <td><a href="bapapprove.php?id=<?php echo $id;?>">APPROVE</a></td><td><a href="bapdelete.php?id=<?php echo $id;?>">DELETE</a></td></tr>
