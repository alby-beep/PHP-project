...
<!-- header -->
	...
	<h2></h2>
        ...
        <form name="frmm" method="post" action="viewmembersaction.php">
<center>
    <table >
  <tr>
      <th scope="row">Id</th> <th scope="row">Name</th><th scope="row">Age</th> <th scope="row">Qualification</th><th scope="row">Contact Number</th>   <th scope="row">Monthly Salary</th> <th scope="row">Father's Name</th><th scope="row">Mother's Name</th>   <th scope="row">Father's Parish</th> <th scope="row">Mother's Parish</th><th>Status</th><th colspan="2">Remarks</th>
  </tr>
  ...
  while ($s2=  mysqli_fetch_assoc($s1))
  {
      ...
      $monthlysalary=$s2['monthlysalary'];
      $fathersname=$s2['fathersname'];
      $mothersname=$s2['mothersname'];
      $fathersparish=$s2['fathersparish'];
      $mothersparish=$s2['mothersparish'];
      $status=$s2['status'];
      $id=$s2['id'];
 ...
 <td><?php echo $age; ?></td><td><?php echo $qualification; ?></td>
 <td><?php echo $contactnumber; ?></td>
 <td><?php echo $monthlysalary; ?></td>
<td><?php echo $fathersname; ?></td>
<td><?php echo $mothersname; ?></td>
<td><?php echo $fathersparish; ?></td>
<td><?php echo $mothersparish; ?></td>
<td><?php echo $status; ?></td>
<td><a href="approve.php?id=<?php echo $id;?>">APPROVE</a></td><td><a href="delete.php?id=<?php echo $id;?>">DELETE</a></td></tr>
