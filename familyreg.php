...
<!-- header -->
	...
	<!-- slider -->
				...
				<h2>REGISTER</h2>
				 ...
				 <form method="post" action="familyreg_action.php">
					...
					<div>
						<span> House Name</span>
                                                <input type="text" name="housename" required pattern="[a-zA-Z]+">
					</div>
					<div>
						<span>House Group</span>
                                                <input type="text" name="housegroup" required pattern="[a-zA-Z.]+"> 
					 </div>
					 <div>
						 <span>Address</span>
                                                 <input type="text" name="address" required pattern="[a-zA-Z]+"> 
					</div>
						<div>
									<span>Family Type</span>
                                                                        <input type="text" name="familytype" required pattern="[a-zA-Z]+">
								</div>
				    ...
				    <div class="col-md-6  register-top-grid">
                                    ...
                                    $s="select * from family where memberid='$memberid'";
                                    $s1=  mysqli_query($con, $s);
                                    while ($s2=mysqli_fetch_assoc($s1))
                                    {
                                        ?>
                                    <table border="1">
                                         <tr><th>HOUSE NAME</th><td><?php echo $s2['housename'];?></td></tr>
                                        <tr><th>HOUSE GROUP</th><td><?php echo $s2['housegroup'];?></td></tr>
                                        <tr><th>ADDRESS</th><td><?php echo $s2['address'];?></td></tr>
                                       <tr><th>FAMILY TYPE</th><td><?php echo $s2['familytype'];?></td></tr>
