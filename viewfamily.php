...
<!-- header -->
	...
	<h2></h2>
        ...
        <form name="frmm" method="post" action="viewfamilyaction.php">
<center>
    <table >
  <tr>
      <th scope="row">Member ID</th><th scope="row">House Name</th><th scope="row">House Group</th> <th scope="row">House Group</th><th scope="row">Family type</th><th scope="row">Status</th><th scope="row" colspan="2">Remarks</th>
  </tr>
  
  <?php
  include 'connection.php';
  $s="select * from family";
  $s1=  mysqli_query($con, $s);
  while ($s2=  mysqli_fetch_assoc($s1))
  {
      $id=$s2['memberid'];
      $housename=$s2['housename'];
      $housegroup=$s2['housegroup'];
      $address=$s2['address'];
      $familytype=$s2['familytype'];
      $status=$s2['status'];
  ...
  ?>
    <tr><td><?php echo $id; ?></td><td><?php echo $housename; ?></td>
 <td><?php echo $housegroup; ?></td><td><?php echo $address; ?></td>
 <td><?php echo $familytype; ?></td>
 <td><?php echo $status; ?></td>
 <td><a href="familyapprove.php?id=<?php echo $id?>">APPROVE</a></td><td><a href="familydelete.php?id=<?php echo $id?>">DELETE</a></td></tr>
